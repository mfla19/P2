...
\end{bmatrix}
\end{align*}
I denne matrice kan man se, at der i dens $(2,3)$-indgang står $4$, hvilket betyder, at den tredje butik har solgt $4$ par sko. Der står i dens $(3,1)$-indgang $3$, hvilket betyder, at den første butik har solgt $3$ par bukser.
\end{eks}
