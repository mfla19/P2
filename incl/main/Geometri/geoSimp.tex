...
\end{proof}
Så længe at $\vec{b}$ ikke er lig nulvektoren kan ethvert lineært programmerings problem derfor omskrives til konveks form. 
Grunden til at $\vec{b}$ skal være forskellig fra nulvektoren, er fordi ellers så er nulvektoren en løsning, og den overholder som den eneste vektor ikke konveksbibetingelsen, da det ikke er tilladt at dividere med nul.
