...
\textbf{Den mulige mængde} $\mathcal{F}$ \textit{(usikker på oversættelsen)} er mængden af alle de mulige løsninger. Den vil derfor for et standard maksimeringsproblem defineres som
\begin{align*}
