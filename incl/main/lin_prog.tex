...
Et eksempel på et lineært programmeringsproblem ses i Eksempel \ref{eks:maksprob1}. Eksemplet er et lineært maksimeringsproblem, da objektfunktionen søges maksimeret. %søges?
...
Omskrivning mellem uligheder %bliver til flagrende overskrifter
\begin{align*}
	\vec{a}_i\vec{x} \geq b_i \quad \Leftrightarrow \quad -\vec{a}_i\vec{x} \leq -b_i
\end{align*}
Omskrivning fra lighed til ulighed % hvorfor bruges der forskellige pile
\begin{align*}
...
Niveaukurverne $46=\vec{c}^T \vec{x}$ og $25=\vec{c}^T \vec{x}$ er på figur \ref{fig:maksprob3} indtegnet for programmeringsprogblemet fra Eksempel \ref{eks:maksprob2}.
	...
	\begin{center}	
		...
		\label{fig:maksprob3} % fejl i billedet, z værdierne skal byttes rundt
	\end{center}
