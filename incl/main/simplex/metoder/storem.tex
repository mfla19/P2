...
En mulig basis løsning til det hjælpende problem fås ved at lade $(x_5, x_6, x_7, x_4) = b = (3,2,5,1)$. 
...
Med en stor nok værdi for M er alle reducerede kost ikke-negative, og der er fundet en optimal løsning til det hjælpende problem.
Alle de kunstige variable er blevet lig nul, hvorfor der nu haves en optimal løsning til det originale problem.  
\end{eks}