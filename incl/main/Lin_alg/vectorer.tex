\subsection{Vektorer}
En vektor er et objekt defineret ved en retning og en længde, som kan repræsenteres som matrix, der enten kun har en sølje eller en række.
...
Hvis en vektor kan lægges til en anden vektor, så må det også være muligt at skalere den. Det vil sige multiplicere den med en konstant, eftersom $2\vec{v}=\vec{v}+\vec{v}$.\\ %giver god mening, men det lyder som et bevis
\begin{figure}[h]
\begin{center}
...
\end{defn}
Bemærk at en $m \times n$ matrix kun kan multipliceres med en $n$ dimentionel søjlevektor ud fra Definition \ref{def:matrixvektorprodukt}, produktet mellem en $m$ dimensional rækkevektor og en $m \times n$ matrix, kan defineres på samme måde, så resultatet bliver en $n$ dimentionel vektor. 
