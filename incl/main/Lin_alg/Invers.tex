...
\end{lma}
\begin{proof}
Af Definition \ref{def:elematrix}, fremgår det, at $E$ er den matrix der forekommer når en række operation $r$ udførers på $I_n$, derfor vil $E^{-1}$ være en inverse rækkeopration af $r$ udført på $I_n$. %Må det være den inverse?? 
