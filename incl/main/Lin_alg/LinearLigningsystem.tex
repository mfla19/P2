...
Koefficienterne i et lineært ligningssystem kan skrives i en matrix, mens variable og konstanterne skrives som vektorer. Et lineært ligningsystem kan så skrives op som en matrixligning på formen $A \vec{x} = \vec{b}$, hvor
...
Søjlerne i $A$ indeholder koefficienterne til variablene $x_1$, $x_2$, $\dots $, $x_n$ og kaldes derfor koefficientmatricen til det lineære ligningssystem. 
...
Derudover gælder, at $rang(A) + null(A) = n$.
\end{defn}
...
\end{bmatrix}.
\end{align*}
Nu er matricen på reduceret trappeform.\\
