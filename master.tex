...
\include{incl/main/linProg/LinearProgramering}
%\include{incl/main/Geometri/Status}
%\endgroup
\include{incl/main/Losninger/Losninger}
\include{incl/main/LosningsMetoder/LosningsMetoder}
\include{incl/main/simplex/SimplexMetoden}
...
\begin{appendices}
  \include{incl/main/Lin_alg/VektoreMatricer}
  \include{incl/main/Lin_alg/LigningsMaster}
  \include{incl/main/Lin_alg/Baser}
