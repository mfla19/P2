...
\documentclass[11pt,a4paper,twoside,openany,danish]{book}

% Variabler, som bruges til automatisk at indsætte titel, forfattere, osv. på
% forsiden og titelbladet.
\def \projecttitle       {Mulige basisløsninger 
\\ \textit{og hvordan de findes}}
\def \projectsubtitle    {Lineær programmering og Simplex metoden}
\def \projecttheme       {Lineær programmering og Simplex metoden}
...
\include{incl/main/Indledning/IndledningMaster}
%\begingroup
%\tikzset{every picture/.style={scale=0.5}}%
\include{incl/main/linProg/LinearProgrameringMaster}
%\include{incl/main/Geometri/Status}
%\endgroup
\include{incl/main/Losninger/LosningerMaster}
\include{incl/main/LosningsMetoder/LosningsMetoderMaster}
\include{incl/main/simplex/SimplexMetodenMaster}
\include{incl/main/Case/case_udkast}
%\include{incl/main/Konklussion}
% Appendicer indsættes inde i en appendices-blok og bliver nummereret med
% bogstaver i stedet for tal
\begin{appendices}
  \include{incl/main/Lin_alg/VektoreMatricerMaster}
  \include{incl/main/Lin_alg/LigningsMaster}
  \include{incl/main/Lin_alg/BaserMaster}
