\begin{tikzpicture}
  ...
  \draw[line width=2pt,blue,-stealth](0,0)--(4,4) node[anchor=south west]{$k\vec{x}$}; %blå vektor
  \draw[line width=2pt,red,-stealth](0,0)--(2,2) node[anchor=north east]{$\vec{x}$}; %rød vektor
\end{tikzpicture}
\begin{tikzpicture}
